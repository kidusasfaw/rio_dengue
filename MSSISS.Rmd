...
ggsave("~/Desktop/UM/RESEARCH/dengue/MSSISS 2018/Predicting Poster/dengue_counts.png", plot3)
```
...
jpeg("~/Desktop/UM/RESEARCH/dengue/MSSISS 2018/Predicting Poster/ols_diagnostics.png")
par(mfrow=c(1,3))
...
plot3 = grid.arrange(grobs = list(plot1, plot2), ncol = 2)
ggsave("~/Desktop/UM/RESEARCH/dengue/MSSISS 2018/Predicting Poster/resid_qq_plot.png", plot3)
# sample ACF (auto-correlation function) plot
jpeg("~/Desktop/UM/RESEARCH/dengue/MSSISS 2018/Predicting Poster/sarma_res_sample_acf.png")
...
ggsave("~/Desktop/UM/RESEARCH/dengue/MSSISS 2018/Predicting Poster/sim_vs_obs.png")
```
